...
public class airportDetailsActionForm extends LookupDispatchAction {
	...
	protected Map getKeyMethodMap() {
		Map map = new HashMap();
		map.put("airportDetailsActionForm.add", "add");
		map.put("airportDetailsActionForm.list", "list");
		map.put("airportDetailsActionForm.listId", "listId");
		map.put("airportDetailsActionForm.edit", "edit");
		map.put("airportDetailsActionForm.emptyaction", "emptyaction");
		return map;
	}
	...
	public ActionForward listId(ActionMapping mapping, ActionForm form,
		...
		object.setAirportName((String)vec1.get(1));
		object.setLocation((String)vec1.get(2));
		object.setAirportCode((String)vec1.get(3));
