...
public class flightDetailsActionForm extends LookupDispatchAction {
	...
	protected Map getKeyMethodMap() {
		Map map = new HashMap();
		map.put("flightDetailsActionForm.add", "add");
		map.put("flightDetailsActionForm.list", "list");
		map.put("flightDetailsActionForm.listId", "listId");
		map.put("flightDetailsActionForm.edit", "edit");
		map.put("flightDetailsActionForm.emptyaction", "emptyaction");
		return map;
	}
	...
	public ActionForward listId(ActionMapping mapping, ActionForm form,
		...
		object.setMakeType((String)vec1.get(2));
		object.setMakeYear((String)vec1.get(3));
