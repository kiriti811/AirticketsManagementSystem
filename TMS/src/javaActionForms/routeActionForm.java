...
public class routeActionForm extends LookupDispatchAction {
	...
	protected Map getKeyMethodMap() {
		Map map = new HashMap();
		map.put("routeActionForm.add", "add");
		map.put("routeActionForm.list", "list");
		map.put("routeActionForm.listId", "listId");
		map.put("routeActionForm.edit", "edit");
		map.put("routeActionForm.emptyaction", "emptyaction");
		return map;
	}
	...
	public ActionForward listId(ActionMapping mapping, ActionForm form,
		...
		object.setRouteId((String)vec1.get(1));
		object.setLocation((String)vec1.get(2));
		object.setNodes(Integer.parseInt((String)vec1.get(3)));
