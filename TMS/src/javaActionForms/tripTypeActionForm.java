...
public class tripTypeActionForm extends LookupDispatchAction {
	...
	protected Map getKeyMethodMap() {
		Map map = new HashMap();
		map.put("tripTypeActionForm.add", "add");
		map.put("tripTypeActionForm.list", "list");
		map.put("tripTypeActionForm.listId", "listId");
		map.put("tripTypeActionForm.edit", "edit");
		map.put("tripTypeActionForm.emptyaction", "emptyaction");
		return map;
	}
	...
	public ActionForward listId(ActionMapping mapping, ActionForm form,
		...
		object.setTypeOfTrip((String)vec1.get(1));
